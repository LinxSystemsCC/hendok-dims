...
function readyMadeLineOrderLine(tag,prodDesc,prodCodes,prodQty,price,cost,instock,titles,tax,unitSizes,prohib,UnitWeight,SoldByWeight,strBulkUnit,ProductMargin,multiLines,linediscount,dicountproperty,urlTax)
{
    ...
    var $row = $('<tr id="new_row_ajax'+tokenId+'" class="fast_remove">' +
        ...
        '<td contenteditable="false" class="col-md-2"><input name="prodDescription_" id ="prodDescription_'+tokenId+'" class="prodDescription_ set_autocomplete inputs" value ="'+prodDesc+'"><input name="col8" id ="col8_'+tokenId+'" class="col8 '+classAnonymouscols+'" readonly></td>' +
        '<td contenteditable="false" class="col-md-4"><input name="odescription_" id ="odescription_'+tokenId+'" class="odescription_ set_autocomplete inputs" value ="'+prodDesc+'"></td>' +
