                ...
                [
                    ...
                    'submenuitems' => [
                        ...
                        [
                            ...
                            'is_allow' => in_array('roofing-report', $allowedItems),
                        ],
                        [
                            'name' => 'Reprint Label',
                            'href' => '/roofingReprint',
                ...
                [
                    ...
                    'submenuitems' => [
                        [
                            ...
                            'is_active' => request()->is('printLabelPage/White Mesh'),
                            'is_allow' => in_array('white-mesh-print-label', $allowedItems),
                        ],
                    ],
                ],
                [
                    ...
                    'submenuitems' => [
                        [
                            ...
                            'is_active' => request()->is('printLabelPage/White Mesh'),
                            'is_allow' => in_array('black-mesh-print-label', $allowedItems),
                        ],
                    ],
                ],
                [
                    ...
                    'submenuitems' => [
                        [
                            ...
                            'is_active' => request()->is('/printLabelPage/Field Fence'),
                            'is_allow' => in_array('field-fence-print-label', $allowedItems),
                        ],
                    ],
                ],
                [
                    ...
                    'submenuitems' => [
                        [
                            ...
                            'is_active' => request()->is('printLabelPage/Nails'),
                            'is_allow' => in_array('nails-print-label', $allowedItems),
                        ],
                    ],
                ],
                [
                    ...
                    'submenuitems' => [
                        [
                            ...
                            'is_allow' => in_array('c-clips-print-label', $allowedItems),
                            'is_active' => request()->is('printLabelPage/C Clips'),
                        ],
                    ],
                ],
                [
                    ...
                    'submenuitems' => [
                        [
                            ...
                            'is_active' => request()->is('printLabelPage/Netting'),
                            'is_allow' => in_array('netting-print-label', $allowedItems),
                        ],
                    ],
                ],
                [
            ...
            'submenuitems1' => [
                ...
                [
                    ...
                    'submenuitems' => [
                        ...
                        [
                            'name' => 'Change Pro-Weigh Truck',
                            'href' => '/pro-weigh',
                            'is_active' => request()->is('pro-weigh'),
                            'is_allow' => in_array('change-pro-weigh-truck', $allowedItems),
                        ],
                    ],
                ],
            ],
            ...
            'submenuitems1' => [
                [
                    ...
                    'submenuitems' => [
                        [
                            'name' => '1',
                            'is_allow' => in_array('returns-1', $allowedItems),
                        ],
                        [
                            'name' => '2',
                            'is_allow' => in_array('returns-2', $allowedItems),
                        ],
                    ],
                ],
                [
                ...
                [
                    ...
                    'submenuitems' => [
                        ...
                        [
                            ...
                            'is_allow' => in_array('edit-galv-product-spec', $allowedItems),
