...
class WireDrawWireDrawWeightController extends Controller
{
    ...
    {
        $jobHeaders = DB::table('tblWireDrawHeaders')->select(DB::raw("CONCAT('WD', tblWireDrawHeaders.intHeaderId) AS intHeaderIdcustom"), 'intWireDrawMachineId', 'tblMachines.strMachineName', 'intNoOfStand', 'tblProductsWireDraw.strProductName', 'tblWireDrawHeaders.intHeaderId', 'tblWireDrawHeaders.intProductId')->leftJoin('tblMachines', 'tblWireDrawHeaders.intWireDrawMachineId', '=', 'tblMachines.intAutoMachineID')->join('tblProductsWireDraw', 'tblWireDrawHeaders.intProductId', '=', 'tblProductsWireDraw.intProductId')->get();
