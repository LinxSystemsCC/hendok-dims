...
<div class="col-lg-12"  style="background: white;">
    <div class="col-lg-2"  style="background: white;border-right: 2px solid black;">
        ...
        <div class="vertical-menu">
            ...
            <a href='{!!url("/machines")!!}' class="active">Machines</a>
                ...
                <fieldset class="well">
                    <form>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="machinenames"  style="margin-bottom: 0px;font-weight: 700;font-size: 15px;">Machine Name </label>
                            <input  type="text" class="form-control input-sm col-xs-1" id="machinenames" style="height:22px;font-size: 10px;font-family: sans-serif;font-weight: 900;">
                        </div>
                        <br>
    ...
    $(document).ready(function() {
        ...
        $('#savemachine').click(function(){
            ...
            $.ajax({
                ...
                url: '{!!url("/savesmachines")!!}',
                type: "POST",
                data: {
                    machinenames: $('#machinenames').val()
            ...
            success: function (data) {
                ...
                $("#gridContainer").dxDataGrid({
                    ...
                    onRowDblClick:function(e){
                        ...
                        console.log(e.data.intAutoMachineID);
                        var palletid =  e.data.intAutoMachineID;
                        var strPalletTypeDescription =  e.data.strMachineName;

                        //data[0].sendto
                        var dialog = $('<p><label>Department Name</label><br><input id="themachine" value="'+strPalletTypeDescription+'"><br></p>').dialog({
