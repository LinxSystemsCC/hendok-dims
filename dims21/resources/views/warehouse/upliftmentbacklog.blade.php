...
<script>
    ...
    var jArray = JSON.stringify({!! json_encode($upliftbacklogdetails) !!});
    var finalDataBacklog = $.map(JSON.parse(jArray), function (item) {
        return {
            strMessage: item.strMessage,
            intUpliftmentNumber: item.intUpliftmentNumber,
...
dataSource:finalDataBacklog, //as json
