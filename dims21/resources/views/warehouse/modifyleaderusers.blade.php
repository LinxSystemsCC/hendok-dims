    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="newuserLabel">Create New User Leader</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label class="control-label" for="areaname"  style="margin-bottom: 0px;font-weight: 700;font-size: 15px;">Username</label>
                    <select  class="form-select input-sm col-xs-1 "id="username">
                        <option></option>
                        @foreach($baseusers as $val)
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="saveusername" class="btn btn-success" >Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var jArray = JSON.stringify({!! json_encode($teamleaders) !!});
