...
<div class="col-lg-12"  style="background: white;">
    ...
    <div class="col-lg-10" >
        <div class="col-lg-12 d-inline-flex" >
            <h3 style="flex-grow: 1; padding-left: 15px;">MAP ITEM TO PALLET</h3>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select  class="form-select input-sm col-xs-1" id="pallettypedesc" required>
                        <option></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-select input-sm col-xs-1" id="productcode">
                            <option></option>
...
<script>
    ...
    $(document).ready(function() {
        $('#productcode').select2( {
            theme: 'bootstrap-5' //TODO This Select 2 is just broken for some reason!
        });
