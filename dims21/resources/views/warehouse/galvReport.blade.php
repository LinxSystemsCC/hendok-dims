        ...
        $("#gridContainer").dxDataGrid({
            ...
            columns: [
                ...
                },
                {
                    ...
                    caption : 'intElongTest',
                },
                {
                    dataField : 'intTorsionTest',
                    caption : 'intTorsionTest',
                },
                {
                    dataField : 'intStressTest',
                    caption : 'intStressTest',
                },
                {
                ...
                },
                {
                    ...
                    caption : 'strStockChange',
                },
                {
                    dataField : 'strQCOperator',
                    caption : 'strQCOperator',
                },
                {
                    dataField : 'strWeighOperator',
                    caption : 'strWeighOperator',
                }
            ],
            summary: {
                totalItems: [{
