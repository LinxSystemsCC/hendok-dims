...
<div class="col-12 d-flex px-0"  style="background: white;">
    ...
    <div class="col p-3" >
        <div class="col-lg-12 d-inline-flex" >
            <h3 style="flex-grow: 1; padding-left: 15px;">SUB DEPARTMENTS</h3>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="newuserLabel">Create New Sub Department</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label class="control-label" for="subdept"  style="margin-bottom: 0px;font-weight: 700;font-size: 15px;">Sub Department</label>
                    <input  type="text" class="form-control input-sm col-xs-1" id="subdept">
                </div>                
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" id="savesubdept" class="btn btn-success" >Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#savesubdept').click(function(){

            $.ajax({

                url: '{!!url("/saveSubDepartment")!!}',
                type: "POST",
                data: {
                    Name: $('#subdept').val()
                },
            ...
            success: function (data) {
                $("#gridContainer").dxDataGrid({
                    ...
                    onRowUpdating: function(e){
                        ...
                        var Name = e.newData.strSubDeptName;

                        $.ajax({
                            url: '{!!url("/updateSubDepartment")!!}',
                            type: "POST",
                            data: {
                                ID:ID,
                                Name:Name,
