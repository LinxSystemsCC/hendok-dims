        ...
        <div class="col-lg-12"  style="background: white;border: 1px solid black;font-size: 11px;margin-left: 45px;margin-right: 25px;width: 80%">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><h5><strong>{{$val->strCustomerName}}</strong></h5></td>
                </tr>
                <tr>
...
@if($fullfilled !="Finished")
    ...
    @else
        <h3 style="color: red;font-weight: 900;">You have Produced Required Quantity Of {{$mnyQtyProduced}} / {{$mnyQtyRequired}}.<br>Please speak to your operator</h3><br><br>
