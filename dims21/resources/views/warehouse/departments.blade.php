...
<div class="col-lg-12"  style="background: white;">
    ...
    <div class="col-lg-10" >
        <div class="col-lg-12 d-inline-flex" >
            <h3 style="flex-grow: 1; padding-left: 15px;">DEPARTMENTS</h3>
            <!-- Button trigger modal -->
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#newdept">
                New Department
            </button>
        </div>
...
<!-- Modal -->
<div class="modal fade" id="newdept" tabindex="-1" aria-labelledby="newuserLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="newuserLabel">Create New Department</h1>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input  type="text" class="form-control input-sm col-xs-1" id="deptname">
                </div>                
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" id="savesdeptname" class="btn btn-success" >Save</button>
            </div>
        </div>
    </div>
</div>
            ...
            success: function (data) {
                ...
                $("#gridContainer").dxDataGrid({
                    ...
                    onRowUpdating: function(e){
                        // console.debug(e);
                        var DeptID = e.oldData.intAutoID;
                        var DeptName = e.newData.strDeptName;
