...
<body>
    <div class="container">
        ...
        <table>
            <tr>
                <td><p>PRODUCT:</p></td>
                <td colspan="2"><p>{{ $job[0]->strProduct }}</p></td>
            </tr>
            <tr>
                <td><p>SIZE:</p></td>
            ...
            <tr>
                <td><p>PACK:</p></td>
                <td><p>{{ $job[0]->strPack }}</p></td>
                <td rowspan="6" class="qrcode">
                    <img src="data:image/png;base64,{{ base64_encode($qrCode) }}" alt="QR Code">
                </td>
            </tr>
            <tr>
                <td><p>COATING:</p></td>
                <td><p>{{ $job[0]->strCoating }}</p></td>
            </tr>
            <tr>
                <td><p>CODE:</p></td>
                <td><p>{{ $job[0]->strProductCode }}</p></td>
            </tr>
            <tr>
                <td><p>DATE:</p></td>
                <td><p>{{ $job[0]->dteJobCreated }}</p></td>
            </tr>
            <tr>
                <td><p>OPERATOR:</p></td>
                <td class="nowrap"><p>{{ $job[0]->strOperator }}</p></td>
            </tr>
            <tr>
                <td colspan="2">
