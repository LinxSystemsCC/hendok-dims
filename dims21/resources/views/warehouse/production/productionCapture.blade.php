    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close closeCaptureModal" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                ...
                <form>
                    <div class="row">
                        ...
                        <div class="form-group mb-2 col-4 ps-0">
                            ...
                            <input type="text" class="form-control w-100 rounded-0 rounded-end" id="inputProductCode" disabled>
                        </div>
                        ...
                        <div class="form-group mb-2 col-3">
                            ...
                            <select  class="form-select w-100" id="selectOperator1" required>
                                ...
                                @foreach($operators as $operator)
                                    <option value="{{$operator->EmployeeCode}}">{{$operator->FirstName}} {{ $operator->LastName }}</option>
                                @endforeach
                            </select>
                        </div>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#selectDepartment').change(function(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        var machines = $.map(JSON.parse(JSON.stringify(data)), function (item) {
                            return {
            ...
            function insertProductCapture(dteOccured, intShiftId, intDepartmentId, intMachineId, strProductCode, fltWeight, intQty, strOperator1, strOperator2, strOperator3, strOperator4, fltScrap, strDowntime1, intReason1, strComment1, strDowntime2, intReason2, strComment2, strDowntime3, intReason3, strComment3, strDowntime4, intReason4, strComment4){
                $.ajax({
                    url: '{!!url("/postProductionCaptureCRUD")!!}',
                    type: "POST",
                    data: {
