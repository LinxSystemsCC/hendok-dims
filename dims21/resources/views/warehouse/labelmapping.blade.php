...
<div class="col-lg-12"  style="background: white;">
    ...
    <div class="col-lg-10" >
        <div class="col-lg-12 d-inline-flex" >
            ...
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#labelmapping">
                New Mapping
            </button>
        </div>
...
<!-- Modal -->
<div class="modal fade" id="labelmapping" tabindex="-1" aria-labelledby="newuserLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="control-label" for="productcategory"  style="margin-bottom: 0px;font-weight: 700;font-size: 15px;">Product Category </label>
                    <select  class="form-select input-sm col-xs-1" id="productcategory" required>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="mapLabelToProdCat" class="btn btn-success" >Save</button>
            </div>
        </div>
    </div>
</div>
