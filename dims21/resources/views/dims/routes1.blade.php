...
<div class="col-lg-12"  style="background: white;">
    ...
    <div class="col-lg-10" >
        <div class="col-lg-12 d-inline-flex" >
            <h3 style="flex-grow: 1; padding-left: 15px;">ROUTES</h3>
            <!-- Button trigger modal -->
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#newRoute">
                New Route
            </button>
            <a href='{!!url("/routemapper")!!}' class="btn btn-primary mx-1">View and Map Routes To Area</a>
...
<!-- Modal -->
<div class="modal fade" id="newRoute" tabindex="-1" aria-labelledby="newRoute" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="newuserLabel">Create New Route</h1>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="saveRoute" class="btn btn-success" >Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        var routes = ({!! json_encode($readRoutesItems) !!});
