            ...
            success: function (data) {
                ...
                $.each(data, function (key, value) {
                    trHTML +='<tr style="font-size: 12px;color: black;background: lightgrey" class="hidden_row1'+counter+' hidden_row"><td style="padding: 0px;width: 10%;">'+
                        '<input type="checkbox" name="unique" id ="unique" style="height: 20px !important;width: 50px !important;"  class="unique" value="' +value.intorderdetailId + '" /></td>' +
                        '<td style="padding: 0px;width: 30%;">'+value.PastelCode+'</td>'+
                        '<td style="padding: 0px;width: 70%;">'+value.PastelDescription+'</td>'+
                        '<td style="padding: 0px;width: 50%;">'+value.strUnickReference+'</td>'+
                        '<td style="padding: 0px;width: 30%;"><input class="mnq" value="'+value.mnyQty+'"></td>'+
                        '</tr>';
                    counter++;
                });
