...
'left=20,top=20,width=1000,height=900,toolbar=1,resizable=0'); return false;" style="color:black;font-size: 15px;font-weight:900;background: #179a17; padding: 4px;">Products Cost History</a>
    ...
    <div class="col-lg-12"   style="height:100%;">
        ...
        <table class="table table-bordered stripe search-table" tabindex=0 id="tblMassProducts" style="height:75%;font-size:11px;  color: black;overflow-y: scroll; width: 100%;font-family: monospace;" >
