                        ...
                        <form>
                            <fieldset class="well">
                                ...
                                <div class="form-group ">
                                    <label class="control-label" for=  "Route" style="margin-bottom: 2px;font-weight: 700;font-size: 11px;"><h4>Choose Route</h4></label>
                                    <select id="Route">
                                        <option value="-99"></option>
                                    </select>
                                </div>
                                <div class="form-group ">
                                    <label class="control-label" for=  "Area" style="margin-bottom: 2px;font-weight: 700;font-size: 11px;"><h4>Choose Area</h4></label>
                                    <select id="area">
                                        <option value="-99"></option>
                                    </select>
                                </div>
                                ...
                                <form>
                                    <div class="table-responsive scrollable text-center">
                                        <table class="table table-borderless" id="tableRoutes">
                                            <thead>
                                            <tr>
                                                <th class="text-center " ><h3>Area ID</h3></th>
                                                <th class="text-center "><h3>Route</h3></th>
                                                <th class="text-center "><h3>Area Name</h3></th>

                                            </tr>
                                            </thead>
                                            <tbody>
                                            @foreach($readRoutesItems as $values)
                                                <tr class="item{{$values->iAreasID}}">
                                                    <td class="text-center" >{{$values->Route}}</td>
                                                    <td class="text-center" >{{$values->areaname}}</td>
                                                </tr>
                                            @endforeach
                                            </tbody>
