...
'left=20,top=20,width=1400,height=950,toolbar=1,resizable=0'); return false;">Advanced</a>
    ...
    <table class="table  search-table" id="tblOnsalesOrder" style=" color: black;overflow-y: scroll; width: 100%;font-family: sans-serif;height: 70%;font-weight: 700;font-size: 36px;" tabindex=0>
        <thead>
