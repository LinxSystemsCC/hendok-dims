...
'left=20,top=20,width=1250,height=1250,toolbar=1,resizable=0'); return false;">Status Picking</a>
                                ...
                                <li>
                                    <a href='{!!url("/viewAwaitingtoinvoice")!!}' onclick="window.open(this.href, 'viewAwaitingtoinvoice',
...
'left=20,top=20,width=1250,height=1250,toolbar=1,resizable=0'); return false;">Assign Weight Tickets</a>
                                ...
                                <li>
                                    <a href='{!!url("/getdimsmanuals")!!}' onclick="window.open(this.href, 'getdimsmanuals',
'left=20,top=20,width=1250,height=1250,toolbar=1,resizable=0'); return false;">Manual Stock Adjustment</a>
                                </li>
                                <li>
...
'left=20,top=20,width=1250,height=1250,toolbar=1,resizable=0'); return false;">Authorise Picking</a>
                                ...
                                <li>
                                    <a href='{!!url("/createPalletConfig")!!}' onclick="window.open(this.href, 'getPickingAuth',
'left=20,top=20,width=1250,height=1250,toolbar=1,resizable=0'); return false;">Job Module</a>
                                </li>
